...
- **Найдены и исправлены баги** в `_pl_folder_delete`, `_pl_folder_delete_many`, `_pl_folder_rename`, `_pl_move_many` — они не обновляли `pinned_folders` при удалении/переименовании/перемещении папок
...
- При удалении/переименовании/перемещении папок `pinned_folders` автоматически обновляется — иначе закреплённые пути становятся «призраками».
